...
class TableInterface(ABC):
    ...
    def CreateTables(self):
        ...
        self.c.execute("CREATE TABLE IF NOT EXISTS sicurezza(nome_utente text PRIMARY KEY, pass text not null , nome_dipendente text not null unique)")
        ...
        self.c.execute("CREATE TABLE IF NOT EXISTS Liquidita (id_transazione INTEGER PRIMARY KEY , tipologia text NOT NULL , categoria text NOT NULL, importo int not null, socio integer,fornitore integer, FOREIGN KEY(fornitore) REFERENCES Fornitore(id_fornitore), FOREIGN KEY(socio) REFERENCES Soci(id_socio))")
